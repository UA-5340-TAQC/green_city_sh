...
public class ProfileTests : BaseTest
{
    ...
    public void EditProfile_ShouldSaveAndRevertChanges()
    {
        ...
        editPage.ClickCheckBoxButton("system notifications", false);
        editPage.ClickCheckBoxButton("likes", false);
        editPage.ClickCheckBoxButton("comments", false);
        editPage.ClickCheckBoxButton("invites", false);
        editPage.ClickCheckBoxButton("places", false);

        Assert.That(editPage.IsSaveBtnEnabled(), Is.True,
